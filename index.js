...
$(document).ready(function() { 
  $('button').click(function() { 
    var css = $('textarea#input').val()
    var ugly = transform(css)
    var pretty = JSON.stringify(ugly, undefined, 2).replace(/"/gm, '\'').replace(/'(.*)':/gm, '$1:').replace(/'([0-9]+|\$.*)'/gm, '$1')
    $('textarea#output').val(pretty)
  }); 
});
